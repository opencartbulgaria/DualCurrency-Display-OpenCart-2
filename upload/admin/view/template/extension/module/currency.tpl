            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-rate"><?php echo $entry_rate; ?> - <?php echo $config_currency; ?></label>
                        <div class="col-sm-10">
                            <input type="text" readonly value="<?php echo $currency_rate; ?>" id="input-rate" class="form-control" />
                        </div>
                    </div>
